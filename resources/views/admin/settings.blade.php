...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ route('settingUpdate') }}" method="post" enctype="multipart/form-data" id="getlogos">
            @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="headerlogo" accept="image/*"
                                            id="headerlogo" required>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="projectName" id="projectName"
                                                placeholder="Business Goals Achieved with Design">
                                        </div>
                                        <div class="form-group">
                                            <label for="projectName">Slogan 2</label>
                                            <input type="text" class="form-control" name="projectName" id="projectName"
                                                placeholder="Praesent rhoncus, felis nec accumsan mattis, urna urna laoreet acus vel ultrices">
                                        </div>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="projectImages"
                                                accept="image/*" id="projectImages">
                                ...
                                <div class="card-body">
                                    <form action="" method="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="projectName" id="projectName"
                                                placeholder="We Lead from the Front">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="projectName"
                                                        id="projectName" placeholder="350+">
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="projectName"
                                                        id="projectName" placeholder="631+">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="custom-file">
