                            ...
                            <form action="{{ route('storeServices') }}" method="post" id="getService">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="serviceName" id="serviceName" placeholder="service">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="serviceIcon" id="serviceIcon" placeholder="service">
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="serviceStatus" id="serviceStatus">
